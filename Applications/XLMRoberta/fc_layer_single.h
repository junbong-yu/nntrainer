 ...
 * @date   14 May 2020
 * @brief  This is Fully Connected Layer Class of Neural Network (single sequence variant)
 ...
 * @brief   fully connected layer (processes only first sequence step in incremental_forwarding)
 */
...
public:
   ...
   */
  FullyConnectedSingleLayer &operator=(FullyConnectedSingleLayer &&rhs) = default;
...
private:
  float lora_scaling;
  std::tuple<nntrainer::props::Unit, nntrainer::props::LoraRank, nntrainer::props::LoraAlpha>
